...
const news_full = () => {
  return (
    <div className="grid grid-cols-9 grid-rows-12 gap-2 p-4">

      <div className="col-span-4 col-start-1 row-start-1 p-4 font-bold text-4xl text-black">
        Cold Weather Alert Issued As Temperatures Set To Plummet
      </div>

      <div className="col-span-4 row-span-2 col-start-1 row-start-2"><br />
        <h4>Sorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc amet vulputate libero et velit interdum, ac aliquet odio mattis.</h4>
      </div>



      <div className="col-span-5 col-start-5 row-start-1 p-4 font-bold text-3xl flex items-center">
        <span className="text-4xl text-black mr-2 leading-none">•</span>
        Trending news
      </div>

      <div className="col-span-3 row-span-2 col-start-5 row-start-2 p-4">
      ...
      <div className="col-span-5 col-start-5 row-start-12 p-4 font-bold text-4xl text-black">
        <span className="text-4xl text-black mr-2 leading-none">•</span>
        Live news
      </div>
    </div>
